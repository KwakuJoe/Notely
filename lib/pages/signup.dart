                  ...
                  InkWell(
                    onTap: () {
                      ...
                      if (_formKey.currentState?.validate() == true) {
                        ...
                        authStore.signupLocal(
                            _formKey.currentState?.instantValue['email'].toString() ??'',
                            _formKey.currentState?.instantValue['password'].toString() ?? '',
                            _formKey.currentState?.instantValue['full_name'].toString() ?? ''
                            );
                      }
                      debugPrint(_formKey.currentState?.instantValue.toString());
                    },
                    child: authStore.isSigningUpLocal.value
